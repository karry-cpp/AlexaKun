# PyInstaller spec for Jimmy.
# Build with:  pyinstaller packaging/jimmy.spec
#
# Output:  dist/jimmy/jimmy.exe  (onedir layout — recommended for large ML deps)
#
# Notes:
...
exe = EXE(
    ...
    strip=False,
    upx=False,
    console=False,             # windowed app; logs go to %APPDATA%\Jimmy\logs
